...
func (b *bunsu) String() string {
	return fmt.Sprintf("%d/%d", b.a, b.b)
}

func (b *bunsu) mul(x int) *bunsu {
	s, t := x*b.a, b.b
	g := gcd(s, t)

	return &bunsu{s / g, t / g}
}

func (b *bunsu) mulb(a *bunsu) *bunsu {
	s, t := a.a*b.b, a.b*b.b
	g := gcd(s, t)
	return &bunsu{s / g, t / g}
}

func (b *bunsu) div(x int) *bunsu {
	s, t := b.a, b.b*x
	g := gcd(s, t)
	return &bunsu{s / g, t / g}
}

func (b *bunsu) less(x *bunsu) bool {
	return b.a*x.b < b.b*x.a
}
