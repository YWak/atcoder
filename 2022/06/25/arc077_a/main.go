...
func (deque *Deque) pushBackInternal(value int) {
...
func (deque *Deque) pushFrontInternal(value int) {
...
func (deque *Deque) popFrontInternal() int {
	node := deque.head
...
func (deque *Deque) popBackInternal() int {
	node := deque.tail
