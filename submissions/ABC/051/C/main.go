...
func main() {
	...
	x := tx - sx
	y := ty - sy
	fmt.Print(strings.Repeat("U", y))
	fmt.Print(strings.Repeat("R", x))
	fmt.Print(strings.Repeat("D", y))
	fmt.Print(strings.Repeat("L", x))
	fmt.Print("L")
	fmt.Print(strings.Repeat("U", y+1))
	fmt.Print(strings.Repeat("R", x+1))
	fmt.Print("DR")
	fmt.Print(strings.Repeat("D", y+1))
	fmt.Print(strings.Repeat("L", x+1))
	fmt.Println("U")
}
