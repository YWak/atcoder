...
func solve5(a5, a4, a3, a2, a1, b5, b4, b3, b2, b1 int) bool {
	debug(5, a1, a2, a3, a4, a5)
	debug(5, b1, b2, b3, b4, b5)
	if a5 > b5 {
		return false
	}
	b5 -= a5
	...
	if solve4(a4-m4, a3, a2, a1, b4, b3, b2, b1+(b5-m4)) {
		return true
	}
	if solve4(a4, a3-m3, a2, a1, b4, b3, b2+(b5-m3), b1) {
		return true
	}
	return false
}

func solve4(a4, a3, a2, a1, b4, b3, b2, b1 int) bool {
	debug(4, a1, a2, a3, a4)
	debug(4, b1, b2, b3, b4)
	if a4 > b4 {
		return false
	...
	return solve3(a3-m3, a2, a1, b3, b2, b1+(b4-m3)) || solve3(a3, a2-m2, a1, b3, b2+(b4-m2)*2, b1)
}

func solve3(a3, a2, a1, b3, b2, b1 int) bool {
	debug(3, a1, a2, a3)
	debug(3, b1, b2, b3)
	if a3 > b3 {
		return false
...
func solve() bool {
	...
	return solve5(a[5], a[4], a[3], a[2], a[1], b[5], b[4], b[3], b[2], b[1])
}
